...
// SAVE_MESH(save_with_num_activation_times) {
...
//                 real n_activations = 0.0f;

//                 if(grid_cell->active) {

//                     real *cell_sv = &ode_solver->sv[grid_cell->sv_position * (ode_solver->model_data.number_of_ode_equations)];

//                     // fprintf(act_file, "%d ", grid_cell->sv_position);

//                     n_activations = cell_sv[12];
//                 }
