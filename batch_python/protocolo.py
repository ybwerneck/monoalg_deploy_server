...
number_layers_bz = """  + str(number_layers_bz) + """
...
parser.add_argument('--nl_bz', action = 'store', dest = 'number_layers_bz', default = '2', required = False, help = 'Número de camadas da border zone')
parser.add_argument('--at', action = 'store', dest = 'analysis_time', default = '800', required = False, help = 'Tempo de simulaçâo após aplicação de um estímulo')
...
number_layers_bz = int(arguments.number_layers_bz)
analysis_time = int(arguments.analysis_time)
...
dir_log_protocolo = dir_protocolo + "/" + "logsProtocolo.txt"
...
#   if os.path.exists(dir_log_protocolo):
#     with open(dir_log_protocolo, "r") as arquivo:
#         for l in range(4):
#             linha = arquivo.readline()
#             linhaVet = linha.split(sep=',')
#             if l == 0:
#                print(linhaVet[0])
#                if int(linhaVet[0]) == 5:
...
#                i = int(linhaVet[0])
#             elif l == 1:
#                print(linhaVet[0], bool(str2bool(linhaVet[0])))
#                save = bool(str2bool(linhaVet[0]))
#             elif l == 2:
#                print(linhaVet[0])
#                dAux = int(linhaVet[0])
#             elif l == 3:
#                print(linhaVet[0])
#                stim = []
#                for s in range(len(linhaVet) - 1):
#                   stim.append(int(linhaVet[s]))
...
#      print(s)
  ...
  while not end:
      ...
      if save:
        ...
        #   with open(dir_log_protocolo, mode = 'w') as txt_file:
        #     txt_file.write(f'{i},\n')
        #     txt_file.write('false,\n')
        #     txt_file.write("-1,\n")
        #     for s in stim:
        #        txt_file.write(f'{s},')
        #     txt_file.write('\n')
          ...
          simulation_time = stim[-1] + analysis_time
        ...
        #   else:
        #       deltas = [stim[-1] + 380 - 10 * i for i in range(dAux, 19)]
        #       dAux = -1
          ...
          for d in range(len(deltas)):   
            ...
            #     txt_file.write(f'{i},\n')
            #     txt_file.write('false,\n')
            #     txt_file.write(f"{d + 1},\n")
            #     for s in range(len(stim) - 1):
            #         txt_file.write(f'{stim[s]},')
            #     txt_file.write('\n')
              
              if taxa_bloqueio > 50.0 or (stim[-1] - stim[-2] == 200):
                  save = True														
                  stim[-1] += 20

                #   with open(dir_log_protocolo, mode = 'w') as txt_file:
                #     txt_file.write(f'{i + 1},\n')
                #     txt_file.write('true,\n')
                #     txt_file.write("-1,\n")
                #     for s in stim:
                #         txt_file.write(f'{s},')
